        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <?= $this->Form->control('username',['type'=>'text','required','placeholder'=>'Username','label'=>false,'class'=>'form-control','disabled'])?>
                </div>
                ...
                <div class="form-group">
                    <?= $this->Form->control('newpassword',['type'=>'password','placeholder'=>'New Password','label'=>false,'class'=>'form-control'])?>
                </div>
